...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "19169648")
    API_HASH  = os.environ.get("API_HASH", "6e4a72fc13ac3486344ea662b002eaed")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7178868942:AAGN9w_CdfXOLlWoin01UF7txnypB7T4hg4") 
    ...
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '1334273918').split()]
    FORCE_SUB   = os.environ.get("FORCE_SUB", "khaan_films") 
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002269044519"))
